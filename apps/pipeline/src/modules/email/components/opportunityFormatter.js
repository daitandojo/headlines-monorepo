        ...
        <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                        <tr>
                            <td style="width: 70px; vertical-align: top;" valign="top">
                                ...
                                <p style="font-size: 12px; color: #a0a0a0; margin: 0;">Est. Net Worth</p>
                            </td>
            ...
            <tr>
              <td style="padding: 16px 0 8px; border-top: 1px solid #444444;">
                  <p style="margin:0; font-size: 14px; color: #4CAF50; font-weight: 600;">👤 Why Contact Now</p>
              </td>
            </tr>
            <tr>
              <td>
                <p style="margin: 0; font-size: 15px; color: #dddddd; line-height: 1.6; font-style: italic;">${contactSummary}</p>
              </td>
            </tr>
            `
                : ""
