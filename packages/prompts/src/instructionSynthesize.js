...
export const instructionSynthesize = {
  ...
  guidelines: [
    ...
    '3. **DETERMINE ALL RELEVANT COUNTRIES (CRITICAL):** For each event, you MUST identify ALL relevant jurisdictions. The source newspaper\'s country is a primary clue, but if the text explicitly mentions other countries playing a significant role (e.g., a London court ruling on a Danish matter), you MUST include both. The final value MUST be an ARRAY of fully-written, UN-recognized sovereign country names. Example: ["United Kingdom", "Denmark"].',
