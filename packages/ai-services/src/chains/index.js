...
import { contactSummaryChain as csc } from "./contactSummaryChain.js";
import { extensiveEnrichmentChain as exric } from "./extensiveEnrichmentChain.js";
...
export const contactSummaryChain = async (input) => csc.generate(input);
...
export const extensiveEnrichmentChain = async (input) => exric.invoke(input);
