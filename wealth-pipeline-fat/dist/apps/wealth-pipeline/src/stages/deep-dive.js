...
import { updateArticleStatus, upsertOpportunity, linkOpportunityToEvent, } from '@wealth/access';
...
export class DeepDiveStage {
    ...
    async extractWithKimi(event, context) {
    ...
    async handleSaveOpportunity(args, eventId) {
        try {
            ...
            if (opportunity) {
                ...
                await updateGraphFromOpportunity(opportunity);
                console.log(`  💰 Opportunity: ${opportunity.reachOutTo} ($${opportunity.lastKnownEventLiquidityMM}M)`);
                return opportunity;
            }
            return null;
        }
